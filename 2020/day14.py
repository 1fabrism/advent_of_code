...
# PART 2:
# Code for part 2 is mostly the same, with the only difference being in
# set_mem() (now set_mem2). Here we now mask the address instead of the 
# value, and we write a new function to calculate all the possible 
# addresses generated by the given mask. To do this, every time we find
# an X in the address, we save a copy to a list, with that bit already
# modified. Basically a kind of tree
